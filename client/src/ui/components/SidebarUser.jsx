    ...
    <div className="flex min-h-screen z-50">
      ...
      <aside className="sidebar fixed top-0 bottom-0 left-0 w-60 bg-[#bfdbf7] text-gray-800 h-screen rounded-tr-3xl rounded-br-3xl flex flex-col shadow-2xl border-r border-blue-200/50">
        ...
        <nav className="flex flex-col text-sm font-medium mt-10 px-4">
          <Link
            to="/dashboard"
            className={`flex items-center p-3 rounded-xl transition-all duration-300 whitespace-nowrap ${
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="drop-shadow-sm">
          ...
          <Link
            to="/peminjaman"
            className={`flex items-center p-3 rounded-xl mt-4 transition-all duration-300 whitespace-nowrap ${
          ...
          <Link
            to="/peminjaman-seksi"
            className={`flex items-center p-3 rounded-xl mt-4 transition-all duration-300 whitespace-nowrap text-sm ${
              currentPath === "/peminjaman-seksi"
                ? "bg-[#022b3a] text-white shadow-lg transform scale-105"
                : "hover:bg-[#022b3a] hover:text-white hover:shadow-md hover:transform hover:scale-102"
            }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 1024 1024" className="drop-shadow-sm">
              <path fill="currentColor" d="M704 192h160v736H160V192h160v64h384zM288 512h448v-64H288zm0 256h448v-64H288zm96-576V96h256v96z" />
            </svg>
            <span className="ml-4 text-[13px] leading-5">Daftar Peminjaman Seksi</span>
          </Link>
